...
vcf.path="/work/seedpod/container/spaa_sample_lists/sppa_filt_m0.8_keep.recode.vcf"
meta.path="/work/seedpod/container/spaa_sample_lists/keep_samples_sppa"
...
fixed_G<-matrix(as.numeric(tG), ncol=12236)
dim(fixed_G)
